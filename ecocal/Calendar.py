...
class Calendar:
    ...
    __slots__: dict = ("startHorizon", "endHorizon", "calendar", "details", "detailedCalendar",
    ...
    def _buildCalendar(self) -> bool:
        requestUrl = f"{API_SOURCE_URL}/{self.startHorizon}T00:00:00Z/{self.endHorizon}T23:59:59Z" \
                     f"?&volatilities=NONE" \
                     f"&volatilities=LOW" \
